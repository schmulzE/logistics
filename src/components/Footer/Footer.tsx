    ...
    <footer className='bg-[#1b1b1b] text-white '>
     <ul className="grid grid-cols-6 my-16 py-8 mx-auto w-4/5  ">
      ...
      <li className="text-base capitalize">
        <ul>
          <li className='mb-6'>company service</li>
      ...
      <li className="text-base capitalize">
        <ul >
          <li className='font-medium'>latest news</li>
