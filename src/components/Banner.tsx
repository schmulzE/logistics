...
const Banner = () => {
  return (
		...
		>
			...
			<div className='absolute top-[40%] left-[42%] text-8xl z-50 text-white'>Logo</div>
			{/* <Link to="#section-2" className='absolute top-[60%] left-[47%] text-5xl bg-[#39ff14] rounded-full z-50 icon-container w-14 h-14'>
				...
				<SwiperSlide data-name="Air Freight">
					<video src={ship} autoPlay muted loop className='w-screen'/>
				</SwiperSlide>
				<SwiperSlide data-name="Land Freight">
					<video src={car} autoPlay muted loop className='w-screen'/>
				</SwiperSlide>	
