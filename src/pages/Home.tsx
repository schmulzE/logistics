...
const Home = () => {
  ...
  return (
		<div className='relative overflow-hidden'>
			...
			<div id="section-8" className="bg-[#dfdfdf] lg:px-32 py-44 hover-zone">
				<p data-cursor="label" data-cursor-label="discover" className="text-4xl text-center font-medium w-[90%] mx-auto hover-zone"> innovative service for easy & fast shipments, transportation coordinated <br/> qualified staff</p>
			</div>
			<Blog />
